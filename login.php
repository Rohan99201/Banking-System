...
<head>
	...
	<?php
    $con = new mysqli('localhost: 3206','root','','mybank');
    define('bankName', 'RedNeck Bank',true);
...
<body style="background: url(images/b.jpg); background-repeat: no-repeat; background-size: cover; min-height:100%">
