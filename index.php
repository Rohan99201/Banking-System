...
<body style="background:#7bf4ea;background-size: 100%">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to RedNeck Bank</h4>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/acc.png" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/not.png" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/photo.jpg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
